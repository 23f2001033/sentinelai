...
181 tests, ~31 seconds. Coverage spans policy-engine semantics, the shipped rule set against
real scenarios, action validation and sensitivity detection, provider resolution and JSON
repair, the REST API, browser-operator integration against a real Chromium, and **seven
